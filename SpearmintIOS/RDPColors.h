...
#define kColor_PanelColor                   [UIColor colorWithRed:1 green:1 blue:1 alpha:0.2]
#define kColor_SettingPanelHeader           [UIColor colorWithRed:1 green:1 blue:1 alpha:0.5]
